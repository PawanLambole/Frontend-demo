...
export default function LoginStudentPage({ onBack, onLogin }: Props) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-12">
        ...
        >
          ...
          <p className="text-gray-400 mb-6">Sign in to continue your learning and track progress.</p>

          <StudentLogin onSubmit={(email, password) => onLogin?.(email, password)} />
        </motion.div>
      </div>
    </motion.div>
  );
